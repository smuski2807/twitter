                ...
                <div class="container-fluid" id="about">
                    <div class="row" style="background-image:url(Img/naturalblack.png)">
                        ...
                        <div class="col-md-8 col-xs-10" style="padding-left:30px;padding-bottom:0px;">
                            ...
                            <p>Tell Vertos:</p>
                            <p><a href="whatsapp://send?text=Guys... Check Out this new Website: Vertotweets.com, My username is: <?php echo $_SESSION['username']?> !" data-action="share/whatsapp/share"><span class="fa fa-whatsapp"></span> Share via Whatsapp</a></p>
